...
const textCounter = () => {
  ...
  return (
    <div className="m-5 border-2 rounded-2xl bg-white">
      <div className="p-5 ">
        <h2 className="font-bold mb-4 text-2xl">文字統計小工具</h2>

        <textarea 
          id="inputText" 
          placeholder="輸入文字..."
          className="border rounded-lg bg-gray-100 p-4 mb-4 w-full min-h-96" 
